  ...
  return (
    <div className="flex flex-col items-center justify-center space-y-6 py-8 text-center bg-card">
      ...
      <Button
        size="lg"
        onClick={onCTAClick}
        className="rounded-2xl px-12 py-7 text-lg font-bold shadow-xl transition-all hover:shadow-2xl hover:scale-105 bg-[#003479] text-primary-foreground hover:bg-[#002a60] border-2 border-primary/20 group"
      >
